...
public class Employee {
    ...
    public void printInfo() {  //в java нет параметров по умолчанию :(
        System.out.println("Full name: " + fullName + "\nPosition: " + position + "\nEmail: " + email + "\nPhone number: " + phoneNumber + "\nSalary: " + salary + "\nAge: " + age + "\n");
    }

    public void printInfo(boolean string) {
        if (string) System.out.println("Full name: " + fullName + " | Position: " + position + " | Email: " + email + " | Phone number: " + phoneNumber + " | Salary: " + salary + " | Age: " + age);
    }
